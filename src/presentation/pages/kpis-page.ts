...
export class KpisPage extends BaseComponent {
  ...
  private async renderChart() {
    const ctx = this.renderRoot.querySelector<HTMLCanvasElement>('#kpi-chart');
    if (!ctx) return;
      ...
      <section class="p-4 pb-24 space-y-3">
        <header class="flex justify-between items-center">
          <div>
            ...
            <p class="text-slate-500 text-sm">Panel para ti y supervisión</p>
          </div>
